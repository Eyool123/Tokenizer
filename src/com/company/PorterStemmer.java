...
public class PorterStemmer {
    ...
    private static String stemStep1a(String input) {
        // SSES -> SS
    ...
    private static String stemStep1b(String input) {
        // (m>0) EED -> EE
    ...
    private static String stemStep1c(String input) {
        if (input.endsWith("y")) {
            String stem = input.substring(0, input.length() - 1);
            String letterTypes = getLetterTypes(stem);
    ...
    private static String stemStep2(String input) {
    ...
    private static String stemStep3(String input) {
        String[] s1 = new String[]{
                "icate",
                "ative",
                "alize",
    ...
    private static String stemStep4(String input) {
    ...
    private static String stemStep5a(String input) {
        if (input.endsWith("e")) {
            String stem = input.substring(0, input.length() - 1);
            String letterTypes = getLetterTypes(stem);
            int m = getM(letterTypes);
    ...
    private static String stemStep5b(String input) {
    ...
    private static char getLastDoubleConsonant(String input) {
        ...
        if (lastLetter == secondToLastLetter && getLetterType((char) 0, lastLetter) == 'c') {
            return lastLetter;
        }
        return 0;
    }
    ...
    private static String getLetterTypes(String input) {
